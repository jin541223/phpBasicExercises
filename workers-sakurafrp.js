...
const github_base = "jin541223/phpBasicExercises";

// 设置站点信息
var default_title	 = "php基础知识练习";					// 站点标题（显示在浏览器标题栏）
var default_intitle	 = "basic knowledge";								// 站点名称（显示在首页）
var default_description  = "欢迎访问 php basic knowledge 博客，本博客分享与 php基础知识 相关的技术以及记录一些日常。"; 	// 站点简介，有利于 SEO
var site_domain		 = "";								// 站点域名
var site_subtitle	 = "php日常记录";							// 站点副标题
var site_favicon	 = "https://cn.tql.ink:4443/gitea/img/favicon.png";				// 站点 Logo

// 博主信息
var owner_name = "zera";									// 博主名字
var owner_logo = "https://secure.gravatar.com/avatar/80962ca1ced98d0e679b2bc315d049f2?s=256"	// 博主头像
var owner_desc = "zera";					// 博主简介
